...
<!--[if lte IE 8]><script src="<?php print $chalk_path; ?>/js/ie/html5shiv.js"></script><![endif]-->
<link rel="stylesheet" href="<?php print $chalk_path; ?>/css/main.css" />
<!--[if lte IE 8]><link rel="stylesheet" href="<?php print $chalk_path; ?>/css/ie8.css" /><![endif]-->
<!--[if lte IE 9]><link rel="stylesheet" href="<?php print $chalk_path; ?>/css/ie9.css" /><![endif]-->
...
?>
		<!-- Scripts -->
			<script src="<?php print $chalk_path; ?>/js/jquery.min.js"></script>
			<script src="<?php print $chalk_path; ?>/js/jquery.scrollex.min.js"></script>
			<script src="<?php print $chalk_path; ?>/js/jquery.scrolly.min.js"></script>
			<script src="<?php print $chalk_path; ?>/js/skel.min.js"></script>
			<script src="<?php print $chalk_path; ?>/js/util.js"></script>
			<!--[if lte IE 8]><script src="<?php print $chalk_path; ?>/js/ie/respond.min.js"></script><![endif]-->
			<script src="<?php print $chalk_path; ?>/js/main.js"></script>
